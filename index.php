<?php
    ...
    if ($stype > 4 and $stype < 8) {
        ...
        FROM euca_gall_cmts_2021 INNER JOIN euca_gall_posts_2021 
        WHERE euca_gall_cmts_2021.cmtpostid = euca_gall_posts_2021.postid".$sk." 
                                        ...
                                        <div class="p-3">
                                            <div class="d-flex bd-highlight align-items-center">
                                                <div class="flex-fill bd-highlight">
                                                    ...
                                                    { echo str_replace($_GET['squery'],"<mark>".$_GET['squery']."</mark>",$board['c_postdata']); }
                                                ...
                                                <div class="flex bd-highlight justify-content-end align-items-center text-end fs-6"><?php
                                                        if ($hidenick) {
                                                            ...
                                                            if ($_GET['squery'] != '' and $stype == 6)
                                                            { echo str_replace($_GET['squery'],"<mark>".$_GET['squery']."</mark>",$board['c_nickname']); }
                                            ...
                                            <div class="p-3">
                                                <div class="d-flex bd-highlight align-items-center">
                                                    <div class="flex-fill bd-highlight">
                                                        ...
                                                        if ($_GET['squery'] != '' and ($stype == 1 or $stype == 2))
                                                    ...
                                                    <div class="flex bd-highlight justify-content-end align-items-center text-end fs-6"><?php
                                                        if ($hidenick == 1) {
                                                            ...
                                                            if ($_GET['squery'] != '' and $stype == 3) {
                                                                echo str_replace($_GET['squery'],"<mark>".$_GET['squery']."</mark>",$board['nickname']); 
                                                            } else {
                                                                echo $board['nickname'];
                                                            }
                                                            if ($board['hasaccount']) { echo "<img src=\"assets/gonic.gif\" width=14px height=14px>";}
